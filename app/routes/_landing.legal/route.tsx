...
export default function Home() {
  return (
    <section className="px-4 py-4 bg-secondary-bg text-primary-text">
      ...
      la chasse en France, à des fins d'information et de sensibilisation. Il ne
      poursuit aucun but commercial.
      ...
      email, pseudo et mot de passe. Ces données sont utilisées uniquement pour
      permettre l'accès sécurisé au site et ne sont ni revendues, ni utilisées à
      des fins commerciales. Conformément au RGPD, vous pouvez demander l'accès,
      la modification ou la suppression de vos données à l'adresse suivante :
      michael.derrien@proton.me
